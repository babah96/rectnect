  ...
  return (
    <div className="outline-none border-none relative">
      ...
      >
        ...
        <h2
          className="text-blackish text-[26px] md:text-[30px] lg:text-[44px]
        ...
        <div
          className="bg-accent text-white text-[14px] md:text-[16px] p-2
            px-4 rounded-lg inline-block cursor-pointer hover:bg-blackish"
        >
          shop new
        </div>
      </div>
